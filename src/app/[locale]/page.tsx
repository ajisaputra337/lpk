...
const JapaneseDecoration = ({ type = "sakura", className = "" }) => {
  // ... (SVG Decoration tetap sama seperti kode asli kamu)
  return null; // (Gw potong dikit biar fokus ke logika i18n)
};
            ...
            <div className="flex flex-col gap-8 lg:flex-row">
              ...
              <div className="relative h-80 w-full overflow-hidden rounded-xl border-2 border-red-700 shadow-2xl md:h-96 lg:w-2/3">
                ...
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d643.6745228607759!2d110.46683188372741!3d-7.005259984878899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708cfc821d6ea7%3A0xad77b41447d11d3c!2sLPK.%20AISHIRO%20GAKUEN!5e0!3m2!1sid!2sid!4v1765081785824!5m2!1sid!2sid" // Ganti dengan embed URL asli kamu
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
