...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/sample-page",
        destination: "/profil/company-profile",
        permanent: true,
      },
      {
        source: "/program-gakkou",
        destination: "/program/sekolah-jepang",
        permanent: true,
      },
      {
        source: "/alur-program-lpk-aishiro",
        destination: "/program/magang-jepang",
        permanent: true,
      },
      {
        source: "/visi-misi.php",
        destination: "/company-profile",
        permanent: true,
      },
      {
        source: "/program/jepang",
        destination: "/",
        permanent: true,
      },
      {
      ...
      {
        source: "/2157-2",
        destination: "/media/success-story",
        permanent: true,
      },
      {
        source: "/im-japan",
      ...
      {
        source: "/sample-page/identitas-lembaga",
        destination: "/profil/company-profile",
        permanent: true,
      },
      {
      ...
      {
        source: "/page/3",
        destination: "/media/galeri",
        permanent: true,
      },
      {
        source: "/semangat-baru-belajar-di-gedung-baru",
        destination: "/",
        permanent: true,
      },
      {
      ...
      {
        source: "/visi-misi-dan-tujuan-lembaga",
        destination: "/profil/visi-misi",
        permanent: true,
      },
      ...
      {
        source: "/pelatihan-job-tobi-scaffolding-perancah-bangunan",
        destination: "/",
        permanent: true,
      },
      {
        source: "/kerja-di-jepang-kenapa-tidak",
        destination: "/",
        permanent: true,
      },
      {
        source: "/tips-untuk-belajar-bahasa-jepang-yang-efektif",
        destination: "/",
        permanent: true,
      },
      {
        source: "/rahasia-sukses-orang-jepang",
        destination: "/",
        permanent: true,
      },
      {
        source: "/shikenujian-kerja-tahun-pertama-job-tobi-scaffolding",
        destination: "/",
        permanent: true,
      },
      {
        source: "/kebudayaan-dan-tradisi-jepang",
        destination: "/",
        permanent: true,
      },
      {
        source: "/sample-page/visi-misi-dan-tujuan-lembaga",
        destination: "/",
        permanent: true,
      },
      ...
      {
        source: "/wp-content/uploads/2014/05/FORMULIR-PENDAFTARAN.docx",
        destination: "/",
        permanent: true,
      },
